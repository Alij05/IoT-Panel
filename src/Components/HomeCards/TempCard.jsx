...
function TempCard({ product, isUserAdmin, deviceState, deviceInfo }) {
    console.log('device State', deviceInfo);
                    ...
                    <div className="modal" onClick={(e) => e.stopPropagation()}>
                        ...
                        <table className="info-table">
                            <tbody>
                                <tr>
                                    <td>شناسه دیوایس :</td>
                                    <td>{deviceInfo.deviceId || deviceInfo.device_Id}</td>
                                </tr>
                                <tr>
                                    <td>نوع دیوایس :</td>
                                    <td>{deviceInfo.deviceType || 'سنسور'}</td>
                                </tr>
                                <tr>
                                    <td>کلاس دیوایس :</td>
                                    <td>{product.device_class || product.deviceClass}</td>
                                </tr>
                                <tr>
                                    <td>نام دیوایس :</td>
                                ...
                                <tr>
                                    <td>دما :</td>
                                    <td>{deviceInfo.state.split('/')[0]} سانتی گراد</td>
                                </tr>
                                <tr>
                                    <td>رطوبت :</td>
                                    <td>{deviceInfo.state.split('/')[1]} درصد</td>
                                </tr>
                                <tr>
                                    <td>باتری :</td>
                                    <td>{deviceInfo.battery_percent}%</td>
                                </tr>
                                <tr>
                                    <td>در حال شارژ :</td>
                                    <td>{deviceInfo.battery_charging ? 'بلی' : 'خیر'}</td>
                                </tr>
                                <tr>
                                    <td>ولتاژ باتری :</td>
                                    <td>{(deviceInfo.battery_v).toFixed(2)} ولت</td>
                                </tr>
                                <tr>
                                    <td>قدرت سیگنال wifi :</td>
                                    <td>{deviceInfo.rssi}</td>
                                </tr>
                                <tr>
                                    <td>نام شبکه (SSID) :</td>
                                    <td>{deviceInfo.ssid}</td>
                                </tr>
                                <tr>
                                    <td>IP :</td>
                                    <td>{deviceInfo.ip}</td>
                                ...
                                <tr>
                                    ...
                                    <td>{(deviceInfo.uptime_ms / 60).toFixed(0)} دقیقه</td>
                                </tr>
                                <tr>
                                    <td>تاریخ و زمان  :</td>
                                    <td>{toJalaliDateString(deviceInfo.time)}</td>
                                </tr>
                            </tbody>
                        </table>
