...
export default function PrivateRoute({ children, adminOnly = false }) {
    ...
    if (loading) {
        return (
            <div
                style={{ position: "fixed", top: 0, left: 0, width: "100%", height: "100%", display: "flex", justifyContent: "center", alignItems: "center", backgroundColor: "#f5f5f5", fontSize: "32px", fontWeight: "bold", color: "#26c6da", zIndex: 9999, flexDirection: "column", }}>
