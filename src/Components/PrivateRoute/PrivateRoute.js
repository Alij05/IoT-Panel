    ...
    if (loading) {
        return (
            <div
                ...
                <div style={{ width: "60px", height: "60px", border: "6px solid #ccc", borderTop: "6px solid var(--blue)", borderRadius: "50%", animation: "spin 1s linear infinite", marginBottom: "20px", }}></div>
                در حال بررسی ورود...
                <style>
                    {`
            @keyframes spin {
